...
export const AGENT_SKILLS: AgentSkill[] = [
  ...
  {
    id: 'menu-ops',
    tool: 'menu.set86 / menu.setPrice',
    name: '86 & repricing',
    what: 'Take an item off, put it back, or reprice to a target margin across POS, cart and site at once.',
    says: '"86 the salmon." · "Hold 70% margin."',
    surface: 'POS',
    status: 'live',
    needs: ['menu-ingest'],
  },
  ...
  },
  {
    ...
    name: 'Menu & page copy',
    what: 'Write item descriptions and the one-line tagline in the owner\'s own voice.',
