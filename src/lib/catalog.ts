...
const ROWS: Row[] = [
  ...
  ['vibe-tab-10-budget-touchscreen', 'Vibe Tab 10" Budget Touchscreen', 14900, 'Terminals', '1787372148347_53afdd09.jpg', 'LLE-TAB-10', ['featured', 'budget', 'terminals', 'counter'], 'A real 10" touchscreen station for the price of one month of most POS contracts.'],
