  ...
  return (
    <div className="rounded-2xl border border-stone-200 bg-white p-5">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          <h2 className="font-bold text-stone-900">Single blended rate (fallback)</h2>
          <p className="mt-1 max-w-2xl text-sm text-stone-600">
            For shops that just want one number on the ticket. Stored on your shop
            {shopName ? ` (${shopName})` : ''} and used only while no jurisdictions are set up above — the moment you
            add a state, county or city, the register uses those instead.
          </p>
        </div>
